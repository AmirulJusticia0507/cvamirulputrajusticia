...
INSERT INTO portfolio (title, description, tech_stack, repo_url, sort_order) VALUES
    ('54_testDNA', 'DNA testing platform - automated sample workflow, test-result processing, and reporting engine. Tech: JavaScript, Node.js.', 'JavaScript, Node.js', 'https://github.com/AmirulJustisia0507/54_testDNA', 1),
    ...
    ('E-Voting System Netizen', 'Online e-voting platform for citizen participation with secure, auditable ballot processing. Tech: Python, Django.', 'Python, Django', 'https://github.com/AmirulJustisia0507/e-voting-system-netizen', 3),
    ('Healthcare Queue Scheduling Engine', 'Hospital queue management system - appointment scheduling and queue allocation engine. Tech: JavaScript, Node.js.', 'JavaScript, Node.js', 'https://github.com/AmirulJustisia0507/healthcare-queue-scheduling-engine', 4),
    ('Islamic Digital Currency Engine', 'Islamic Digital Currency Engine (IDCE) - asset-backed, sharia-compliant ledger and payment engine built on NewSQL (CockroachDB) for strict ACID financial consistency, integrated with legal modules (notary & law firm) and supervised by a Sharia Supervisory Board. Tech: JavaScript, Node.js, CockroachDB.', 'JavaScript, Node.js, CockroachDB', 'https://github.com/AmirulJustisia0507/islamic-currency-engine', 5),
    ('Lex Integrity', 'Local AI Policy & Regulatory Compliance Matrix - legal integrity analysis and automatic regulation-contradiction tracker built with MERN stack + Local LLM (100% offline). Maps the Indonesian legal hierarchy (UU, PP, Perpres, Perda), detects discretion gaps (abuse of power), analyzes policy impact, and recommends sanctions visually. Tech: JavaScript, MERN, Local LLM.', 'JavaScript, MERN, Local LLM', 'https://github.com/AmirulJustisia0507/lex-integrity', 6),
    ('lex-integrity.vercel.app', 'Testing project for Lex Integrity - local AI policy & regulatory compliance matrix deployed on Vercel.', 'JavaScript, MERN, Local LLM', 'https://lex-integrity.vercel.app', 10),
    ...
    ('STT Engine', 'Speech-to-Text engine for Indonesian language - real-time transcription API with deep learning models. GitHub: https://github.com/AmirulJusticia0507/stt-engine.git', 'JavaScript, Node.js, Deep Learning', 'https://github.com/AmirulJusticia0507/stt-engine.git', 11),
    ('Face Recognition', 'Face recognition system for identity verification and attendance tracking. Built with Python, OpenCV, and deep learning models for real-time face detection and recognition.', 'Python, OpenCV, Deep Learning', 'https://github.com/AmirulJusticia0507/face_recognition.git', 12),
    ('PharmAI', 'AI-powered pharmaceutical analysis platform for drug discovery and medication safety. Uses machine learning models for drug interaction prediction, dosage optimization, and adverse effect detection.', 'Python, FastAPI, Machine Learning', 'https://github.com/AmirulJusticia0507/PharmAI.git', 13),
    ('Boso Jawa AI', 'Javanese language AI model for natural language processing, translation, and cultural preservation. Built with transformer architectures for low-resource language understanding.', 'Python, PyTorch, Transformers', 'https://github.com/AmirulJusticia0507/boso-jawa-ai.git', 14)
ON CONFLICT DO NOTHING;
